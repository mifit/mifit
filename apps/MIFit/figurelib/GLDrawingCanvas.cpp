...
void GLDrawingCanvas::OnChangeFonts(const MIActionEvent &evt)
{
    ...
    switch (evt.GetId())
    {
    case ID_ASP_ATOM_FONTS:          fsize = Drawing::ATOM_LABEL_SIZE;
        break;
    case ID_ASP_RESIDUE_FONTS:       fsize = Drawing::RESIDUE_LABEL_SIZE;
        break;
    case ID_ASP_HYDROGEN_BOND_FONTS: fsize = Drawing::HBOND_LABEL_SIZE;
        break;
    case ID_ASP_ANNOTATION_FONTS:    fsize = Drawing::ANNOTATION_LABEL_SIZE;
        break;
    default: break;
    }
