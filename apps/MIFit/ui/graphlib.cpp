...
GraphWindow::GraphWindow(QWidget *parent) : QGLWidget(parent) {
...
void GraphWindow::graph_pop_scale() {
  ...
  maxy = scale_stack.back(); scale_stack.pop_back();
  maxx = scale_stack.back(); scale_stack.pop_back();
  miny = scale_stack.back(); scale_stack.pop_back();
  minx = scale_stack.back(); scale_stack.pop_back();
}
