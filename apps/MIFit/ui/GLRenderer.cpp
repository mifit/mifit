...
GLRenderer::GLRenderer()
  :  pickingEnabled(false), qcanvas_win(NULL), popStackImage(NULL),
     minimizeStackImage(NULL), unminimizeStackImage(NULL), closeStackImage(NULL),
     hideHydrogens(false), light(NULL), light2(NULL), frustum(NULL), camera(NULL), currentModel(true), fogEnabled(false),
     antialiasLines(true), joinBondsOfSameColor(true), showBondOrders(false), fontSize(ATOMLABEL::defaultSize()), viewVectorSet(false)
     {
