...
int SmilesReader::CountAtoms() {
  ...
  while (*ptr) {
    switch (*ptr) {
      case 'C': _natoms++; ptr++; break;
      case 'N': _natoms++; ptr++; break;
      case 'O': _natoms++; ptr++; break;
      case 'P': _natoms++; ptr++; break;
      case 'S': _natoms++; ptr++; break;
      case 'F': _natoms++; ptr++; break;
      case 'I': _natoms++; ptr++; break;
      case 'B': _natoms++; ptr++; break;
      case 'H': _natoms++; ptr++; break;
      case 'D': _natoms++; ptr++; break;  //Deuterium
      case 'T': _natoms++; ptr++; break;  //Tritium
