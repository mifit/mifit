...
int CurrentValence(const MIAtom& atom,
  ...
  switch (nPart) {
    case 1: valence += 2; break;
    case 2: valence += 3; break;
    case 3: valence += 4; break;
    case 4: valence += 5; break;
    case 5: valence += 6; break;
    case 6: valence += 7; break;
  }
...
void HybridizeTerminalAtom(MIAtom& atom, std::vector<Bond>& bonds) {
  ...
  switch (order) {
    case TRIPLEBOND: atom.setHybrid(1); break;
    case DOUBLEBOND: atom.setHybrid(2); break;
    case PARTIALDOUBLEBOND: atom.setHybrid(2); break;
    case SINGLEBOND: atom.setHybrid(3); break;
  }
}
