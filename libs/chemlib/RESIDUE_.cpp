...
RESIDUE::RESIDUE() : Residue(), next_res(NULL), prev_res(NULL) {
}

RESIDUE::RESIDUE(const RESIDUE& lhs) : Residue(lhs), next_res(NULL), prev_res(NULL) {
...
RESIDUE::RESIDUE(const Residue& r) : Residue(r), next_res(NULL), prev_res(NULL) {
}
