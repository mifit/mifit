...
class MIMoleculeBase : public QObject {
  ...
  MIMoleculeBase& operator=(const MIMoleculeBase& /* mol */) { return *((MIMoleculeBase*)0); } // NOTE: broken implementation just to avoid compiler warning, do not use!
