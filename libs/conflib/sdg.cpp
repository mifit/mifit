...
sdgEngine::sdgEngine(vector<sdgDistance>& dists, vector<sdgVolume>& vols, const vector<MIAtom*>& atoms)
  : _distances(dists), _volumes(vols), _atoms(atoms) {
...
sdgDistance::sdgDistance(MIAtom& a1, MIAtom& a2, double lower, double upper, bool isRange)  : _a1(a1), _a2(a2) {
  _isOpenEnd = false;
  _isRange = isRange;
  _lower = lower;
  _upper = upper;
...
sdgDistance::sdgDistance(MIAtom& a1, MIAtom& a2, double ideal_dist, bool isRange)  : _a1(a1), _a2(a2) {
  _isOpenEnd = isRange;
  _isRange = isRange;
  _lower = ideal_dist;
}

sdgDistance::sdgDistance(const sdgDistance& orig) : _a1(orig._a1), _a2(orig._a2) {
...
sdgVolume::sdgVolume(MIAtom& center, MIAtom& a1, MIAtom& a2, MIAtom& a3, double lower, double upper, int openEnd)
  : _center(center), _a1(a1), _a2(a2), _a3(a3) {
  _isRange = true;
  _openEnd = openEnd;
  _lower = lower;
  _upper = upper;
...
sdgVolume::sdgVolume(const sdgVolume& orig) : _center(orig._center),
  _a1(orig._a1), _a2(orig._a2), _a3(orig._a3) {
  _isRange = orig._isRange;
